# Generated by Django 4.2.23 on 2025-08-22 20:57
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dokument_podstawowy', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='faktury.enhancedfaktura', verbose_name='Dokument podstawowy (dla korekt)')),
                ('nabywca', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='faktury_nabywca', to='faktury.kontrahent', verbose_name='Nabywca')),
                ('sprzedawca', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='faktury_sprzedawca', to='faktury.firma', verbose_name='Sprzedawca')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('faktura', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pozycje', to='faktury.enhancedfaktura', verbose_name='Faktura')),
            ],
            options={
